window.function = async function(api_key, vector_store_id, batch_id) {
    // Validate API Key
    if (!api_key.value) {
    ...
    // API endpoint URL
    const apiUrl = `https://api.openai.com/v1/vector_stores/${vector_store_id.value}/file_batches/${batch_id.value}/cancel`;
